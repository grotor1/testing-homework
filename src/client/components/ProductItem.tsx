...
export const ProductItem: React.FC<ProductItemProps> = ({ product }) => {
    return (
        <div data-testid={`${product.id}-card`} className={bem(null, ['card', 'w-100', 'mb-4'])}>
            ...
            <div className="card-body">
                ...
                <Link to={`/catalog/${product.id}`} data-testid={`${product.id}-link-card`} className={bem('DetailsLink', ['card-link'])}>Details</Link>
